...
Widget _agreementBtn(setAgreementResult, agreementResult) {
  return Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
    ...
    Expanded(
        child: Text(
      '약관의 내용을 충분히 이해하며 본 상품에 가입함을 확인합니다.',
...
Widget _checkIcon(setAgreementResult, agreementResult) {
  return InkWell(
    ...
    child: Container(
      ...
      child: Icon(
        Icons.check,
        color: agreementResult ? Colors.white : Colors.grey,
        size: 20,
      ),
    ),
  );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                      ...
                      Expanded(
                          child: Form(
                              ...
                              child: renderPhoneNumberFormField(
                                  ...
                                  onSaved: (val) async {
                                    print(
                                        '핸드폰번호 입력 => accessToken: $_accessToken, memberKey: $_memberKey, phone: $val');
      ...
      bottomSheet: BottomBtn(
        ...
        isDisabled:
            _phoneAuthenticationResult && _verificationResult ? false : true,
      ),
    );
  }
}
