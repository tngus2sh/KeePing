...
//         text: '만들기',
//         action: () async {
//           final response = makePiggy(
//             accessToken: _accessToken,
//             memberKey: _memberKey,
//             content: Provider.of<AddPiggyProvider>(context, listen: false).content, 
//             goalMoney: Provider.of<AddPiggyProvider>(context, listen: false).goalMoney,
//             authPassword: authPassword,
//             uploadImage: Provider.of<AddPiggyProvider>(context, listen: false).imgPath,
//           );
//           if (response != null) {
