              ...
              child: Column(
                children: [
                  ...
                  renderTextFormField(
                      ...
                      onSaved: (val) {
                        context
                            .read<AddPiggyProvider>()
                            .setGoalMoney(double.parse(val));
                      },
                      validator: (val) {
                        if (val.length < 1) {
...
Future<dynamic> _patchPiggyImage(
    dynamic headers, dynamic baseUri, dynamic data) async {
  ...
  try {
    ...
    var response = await dio.post('/bank-service/piggy/yoonyeji', data: data);
    print('업로드 성공');
